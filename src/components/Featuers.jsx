...
import { FiMessageCircle, FiMapPin, FiBell, FiUsers } from 'react-icons/fi';

const features = [
  {
    icon: <FiMessageCircle className="text-3xl text-black" aria-label="Chat Support" />,
    title: '24/7 Chat Support',
    desc: 'Get instant replies to your academic and campus-related queries anytime.',
  },
  {
    icon: <FiMapPin className="text-3xl text-black" aria-label="Campus Navigation" />,
    title: 'Campus Navigation',
    desc: 'Find any department, building, or office with chatbot-guided directions.',
  },
  {
    icon: <FiBell className="text-3xl text-black" aria-label="Real-Time Notifications" />,
    title: 'Real-Time Notifications',
    desc: 'Never miss out on important events, deadlines, or updates.',
  },
  {
    icon: <FiUsers className="text-3xl text-black" aria-label="Student Services Access" />,
