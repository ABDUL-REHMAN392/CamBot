      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center text-center px-4">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
            <NavLink
              to="/login"
              className="px-6 py-3 text-white border border-white rounded-md hover:bg-white/10 transition-colors text-center"
            >
              Login
            </NavLink>
            <NavLink
              to="/signup"
              className="px-6 py-3 bg-white text-black rounded-md hover:bg-white/90 transition-colors text-center"
            >
              Sign Up
            </NavLink>
          </div>
